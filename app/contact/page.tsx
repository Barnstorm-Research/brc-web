...
const ContactPage = () => {
  return (
    <main className="flex flex-col p-6 sm:p-12 flex-1">
      ...
      <div className="gap-x-12 gap-y-6 grid-cols-1 lg:grid-cols-2 grid">
        {/* <div className="bg-white flex-col justify-between items-start flex overflow-hidden rounded-xl"> */}
        <div className="group w-full mt-0 mb-[15px] max-w-xl mx-auto bg-neutral-50 rounded-md p-6 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-500 delay-75 border border-solid border-neutral-300">
        ...
        <div className="tracking-[0] text-base font-normal leading-[132%] block">
          <div className="sm:px-4 pb-36 pt-12">
            <div className="relative m-auto sm:p-14 max-w-2xl">
              ...
              <Image
                ...
                width={400}
                height={100}
                className="pb-16 mx-auto max-w-full"
              />
              <p className="max-w-4xl m-auto text-center sm:p-4 relative text-xl font-extralight text-neutral-700">
                <a
                  href="mailto: ideas@barnstormresearch.com"
                  className="text-main-accent font-semibold text-[15px] sm:text-lg xl:text-xl"
                >
